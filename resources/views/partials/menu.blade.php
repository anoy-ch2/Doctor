        ...
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            @can('patient_access')
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        @can('patient_list_access')
                            <li class="{{ request()->is('admin/patient-lists') || request()->is('admin/patient-lists/*') ? 'active' : '' }}">
                                <a href="{{ route("admin.patient-lists.index") }}">
                                    <i class="fa-fw fas fa-cogs">

                                    </i>
                                    <span>{{ trans('cruds.patientList.title') }}</span>
                                </a>
                            </li>
                        @endcan
